...
{
    public partial class FrmMusteriOdemeEkle : Form
    {
        DataBase db = new DataBase();
        Function function = new Function();
        Theme theme;
        public FrmMusteriOdemeEkle()
        {
            InitializeComponent();
        }
        private void FrmMusteriOdemeEkle_Load(object sender, EventArgs e)
        {
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                db.Add_HesapHareket_Database(list[0].MusteriKod, txtIslemNo.Text,
                    comboOdemeSekli.Text + " Ödeme", txtAciklama.Text, 0, "", 0, 0,
