...
namespace BarkodluOtomasyon
{
    public partial class FrmStokRaporlari : Form
    {
        ...
        private void btnListeGoruntule_Click(object sender, EventArgs e)
        {
            ...
            function.ListDoldurStokRapor(listeSatisAyrinti,
                tarihB, tarihS, txtTAlisTutar, txtTSatisTutar1, txtTKar);
            txtTKayitSayisi.Text = listeSatisAyrinti.RowCount.ToString();
        }
        private void btnListeGoruntule1_Click(object sender, EventArgs e)
        {
            function.ListDoldurStokRaporKategori(listeSatisAyrinti_1, comboKategori.Text,
                txtTAlisTutar_1, txtTSatisTutar1_1, txtTKar_1);
            txtTKayitSayisi_1.Text = listeSatisAyrinti_1.RowCount.ToString();
        }
        private void btnListeGoruntule2_Click(object sender, EventArgs e)
        {
            function.ListDoldurStokRaporTukenen(listeSatisAyrinti_2,
                txtTAlisTutar_2, txtTSatisTutar1_2, txtTKar_2);
            txtTKayitSayisi_2.Text = listeSatisAyrinti_2.RowCount.ToString();
        }
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    saveFile.FileName = "backup_StokRapor_excel.xls";
        ...
        {
            function.ListeYazdır(sender, e, listeSatisAyrinti, "Stok");
        }
        ...
        {
            function.ListeYazdır(sender, e, listeSatisAyrinti_1, "Stok");
        }
        ...
        {
            function.ListeYazdır(sender, e, listeSatisAyrinti_2, "Stok");
        }
